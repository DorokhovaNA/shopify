...
([function(e,t,n){
    ...
    function(e,t,n){
        ...
        var t={},n=new r,
        o=new i(e,e.document.body,n),s=new a;
        t.platform=o.facade(),t.apps=n.facade(),
        t.analytics=s.facade(),e.eapps=t
        }}
        n(3);
    ...
    function(e,t,n){
        var o=n(6),
        i=n(7),r=n(8),a=n(18),s=n(24),c="prototype",
        l=function e(t,n,l){
            var p,u,f,d,g=t&e.F,h=t&e.G,b=t&e.S,v=t&e.P,m=t&e.B,
            w=h?o:b?o[n]||(o[n]={}):(o[n]||{})[c],y=h?i:i[n]||(i[n]={}),x=y[c]||(y[c]={});
            h&&(l=n);
            for(p in l)u=!g&&w&&void 0!==w[p],f=(u?w:l)[p],d=m&&u?s(f,o):v&&"function"==typeof f?s(Function.call,f):f,
            w&&a(w,p,f,t&e.U),y[p]!=f&&r(y,p,d),v&&x[p]!=f&&(x[p]=f)
        };
        o.core=i,
        l.F=1,l.G=2,l.S=4,l.P=8,l.B=16,l.W=32,l.U=64,l.R=128,e.exports=l
    },
    function(e,t){
        var n=e.exports="undefined"!=typeof window&&window.Math==Math?window:"undefined"!=typeof 
    ...
    function(e,t,n){
        e.exports=!n(13)&&!n(14)(function(){return 7!=Object.defineProperty(n(15)("div"),"a",{get:function(){return 7}}).a})
    },
    function(e,t,n){
        e.exports=!n(14)(function(){return 7!=Object.defineProperty({},"a",{get:function(){return 7}}).a})
    },
    function(e,t){
        e.exports=function(e){
            try{
    ...
    function(e,t,n){
        ...
        n(7).inspectSource=function(e){return s.call(e)},
    ...
    function(e,t,n){
        ...
        e.exports=function(e){
            return function(t,n,a){
                var s,c=o(t),l=i(c.length),
                p=r(a,l);
                if(e&&n!=n){
                    for(;l>p;)if(s=c[p++],s!=s)return!0
                }
                else for(;l>p;p++)if((e||p in c)&&c[p]===n)
                return e||p||0;
                return!e&&-1
            }
        }
    ...
    function(e,t,n){
        ...
        e.exports=function(e,t){
            ...
            return function(t,s,g){
                ...
                if((f||x in m)&&(h=m[x],b=w(h,x,v),e))if(n)C[x]=b;
                else if(b)switch(e){case 3:return!0;case 5:return h;case 6:return x;case 2:C.push(h)}else if(p)return!1;
                return u?-1:l||p?p:C
            }
        }
    },
    ...
    function(e,t){
        e.exports=function(e,t,n){
            var o=void 0===n;switch(t.length){case 0:return o?e():e.call(n);case 1:return o?e(t[0]):e.call(n,t[0]);case 2:return o?e(t[0],t[1]):e.call(n,t[0],t[1]);case 3:return o?e(t[0],t[1],t[2]):e.call(n,t[0],t[1],t[2]);case 4:return o?e(t[0],t[1],t[2],t[3]):e.call(n,t[0],t[1],t[2],t[3])}return e.apply(n,t)
        }
    },
    function(e,t,n){
        var o=n(53),i=n(54),r=n(57),a=n(58),s="eapps.Platform",c=function(e,t,n){
            ...
            l.getWidgetsElements=function(e){
                ...
                var n=Array.prototype.slice.call(e.getElementsByTagName("elfsight-app")),o=Array.prototype.slice.call(e.querySelectorAll('*[class^="elfsight-app"]')),i=o.concat(n);
            ...
            l.watchWidgetReset=function(){
                window.addEventListener("message",function(e){
                    var t=e.data;t.action&&"EappsPlatform.widgetReset"===t.action&&l.resetWidget(t.widgetId)
                })
            },
            ...
            l.initWidget=function(e){
                ...
                if(o){if(!o.status)return void l.logError('Widget "'+t+'" can`t be initialized because '+o.reason,e);
            ...
            l.boot=function(t,n){
                ...
                if(o.length){
                    ...
                    a=(e.eappsCustomPlatformUrl?e.eappsCustomPlatformUrl:"https://apps.elfsight.com")+"/p/boot/",s=i.stringify({w:o.join(",")});
            ...
            l.loadAssets=function(t){
                t&&t.length&&t.filter(function(e){
                    ...
                    n.src=t,n.setAttribute("defer","defer"),
